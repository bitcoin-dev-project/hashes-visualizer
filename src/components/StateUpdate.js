import { decimalToBinary, rotateRight } from '../lib/encoding'
...
function StateUpdate({ w, letters, base, clock, k, hsBefore, hs, masterClock, lastClock, result }) {
  ...
  return (
    <div className="mb-3">
      ...
      <h2 className="font-semibold my-1 text-slate-100">
      ...
      <div className="flex">
        <div className="flex">
          ...
          <div className="mr-3 w-">
            <div>= Temp1 + Temp2</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[0]) }</span></div></div>}
            <div>&nbsp;</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[1]) }</span></div></div>}
            <div>&nbsp;</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[2]) }</span></div></div>}
            <div>&nbsp;</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[3]) }</span></div></div>}
            <div>= d + Temp1</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[4]) }</span></div></div>}
            <div>&nbsp;</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[5]) }</span></div></div>}
            <div>&nbsp;</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[6]) }</span></div></div>}
            <div>&nbsp;</div>
            { execute && <div className="mb-1"><div>+</div><div>─► <span className="text-slate-900 border border-slate-300 bg-slate-100 px-1 rounded">{ displayHex(hs[7]) }</span></div></div>}
          </div>
        </div>
      </div>
