import { decimalToBinary } from '../lib/encoding'
...
function InitialState({ letters, base, labels = [], clock }) {
  ...
  if(clock < 50) return null;

  return (
    <div className="ml-8">
      <ReactTooltip />
      <h2 className="font-semibold my-1 text-slate-100">Working variables</h2>
      <div className="flex">
        <div>
