import Sigma from "./LowerSigma";
import WExpansion from "./WExpansion";

function WCalculation({ letters, clock, wView, base, k }) {
      ...
      {clock < 50 && clock >= 0 ?
        <div className="mt-5 flex">
          ...
          <div>
            ...
            <WExpansion w={wView} firstLoop={clock + 15} base={base} />
          </div>
        </div> : null
      }
    </div>
