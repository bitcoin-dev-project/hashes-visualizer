import Temp1 from "./T1Compute";
import Majority from "./MajFunction";
import Temp2 from "./T2Compute";
import StateUpdate from "./StateUpdate";
import Choice from "./ChFunction";
import SigmaUpper from "./UpperSigma";
      ...
      {clock < 50 && clock >= 0 ? null :
        <div className="mt-5 flex">
          ...
          <div>
            ...
            <StateUpdate w={wView} letters={letters} base={base} clock={clock} k={k} hsBefore={hsBefore} hs={hs} lastClock={lastClock} masterClock={masterClock} result={result}/>
          </div>
        </div>
      }
    </div>
